...
// var TOKEN_SERVER_TIME = 1669644001.109; // 坑.....
...
var qn = function() {
    ...
    return l["prototype"]["toBuffer"] = function() {
...
!function(n) {
    ...
    function P() {
        ...
        S[R] = 0,
        S[h] = 505497997,
        S[b] = 3812, // 检测浏览器环境. 拿到浏览器运行的结果就可以了....
        S[g] = 1,
        S[w] = 10,
        S[m] = 5
    }
