...
function d(d, e, f, g) {
    var h = {}
        , i = a(16); // 报错. 没有a. 怎么办, 找到a, 把a补上.
    return h.encText = b(d, g), // 报错b没有.
...
// 准备好参数
arg1 = '{"ids":"[1325905146]","level":"standard","encodeType":"aac","csrf_token":""}';
arg2 ='010001';
...
// // 完成. 一个完整的调用逻辑
// var ret = d(arg1, arg2, arg3, arg4)
// // 如果没错. 这里应该得到结果.
// console.log(ret);

function fn(arg1){
    return d(arg1, arg2, arg3, arg4)
}
// 周五停课一次...
